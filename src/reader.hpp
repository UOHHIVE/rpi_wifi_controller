...
protected:
  void OnMessage_Node(const Generated::Node *data) override {
    ...
    Logger::log("New Position: (" + std::to_string(pos->x()) + ", " + std::to_string(pos->y()) + ", " + std::to_string(pos->z()) + ")", LogLevel::Level::DEBUG);
    Logger::log("New Rotation: (" + std::to_string(rot->x()) + ", " + std::to_string(rot->y()) + ", " + std::to_string(rot->z()) + ", " + std::to_string(rot->w()) + ")", LogLevel::Level::DEBUG);
